  ...
  $.fn.tweet = function(o){
    ...
    function relative_time(date) {
      ...
      if (delta < 60) {
        ...
        r = (parseInt(delta / 60, 10)).toString() + ' minuter sedan';
      } else if(delta < (2*60*60)) {
        r = 'en timme sedan';
      } else if(delta < (24*60*60)) {
        r = '' + (parseInt(delta / 3600, 10)).toString() + ' timmar sedan';
      } else if(delta < (48*60*60)) {
        r = 'en dag sedan';
      } else {
        r = (parseInt(delta / 86400, 10)).toString() + ' dagar sedan';
      }
      return r;
    }
    ...
    function extract_template_data(item){
      ...
      o.retweet_action = t('<a class="tweet_action tweet_retweet" href="{retweet_url}"><img src="/site/images/retweet_16x16.png" alt="Dela" title="Dela" border="0"/></a>', o);
